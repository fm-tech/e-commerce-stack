<template>
    <div id="MenuOverlay" class="fixed z-50 bottom-0 h-full w-full
    bg-white px-3
    ">
        ...
        <div class="flex items-center justify-between pt-5">
            <ul class="w-full">
                <li @click="goTo('orders')" class="relative
                    flex
                    items-center
                    justify-between
                    py-2.5
                ...
                <li @click="got('shoppingCart')" class="relative
                    flex
                    items-center
                    justify-between
                    py-2.5
                ...
                <li v-else @click="signOut()" class="relative
                    flex
                    items-center
                    justify-between
                    py-2.5
